...
const HeroBanner = () => {
    ...
    return (
            ...
            <Wrapper>
                ...
                >
                    <div className="flex items-center gap-[6px]">
                        ...
                        <div>someshsrichandan@gmail.com</div>
                    </div>
                ...
                >
                    <div className="font-light mb-4">
                        👋 Hi, I Am{" "}
                        <span className="font-semibold">Somesh Srichandan Sahoo,</span>
                    </div>
                    <div className="max-w-[510px]">
                    I am a student, a learner, and a curious mind. I may not have the same level of experience as some, but I have something equally valuable – a passion and a commitment to delivering high-quality solutions.
                    </div>
                </motion.div>
        ...
        <a href="https://www.linkedin.com/in/someshsrichandan/" style={iconStyle}>
          <i className="fab fa-linkedin"></i>
        </a>
        <a href="https://github.com/someshsrichandan/" style={iconStyle}>
          <i className="fab fa-github"></i>
        </a>
        <a href="https://twitter.com/me__somesh" style={iconStyle}>
